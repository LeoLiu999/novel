...
Route::domain($mobileSite)->namespace('mobile')->group(function(){
    ...
    Route::get('m_actionGetFinish', 'BookController@actionGetFinish')->name('m_actionGetFinish');
...
Route::domain($defaultSite)->namespace('www')->group(function(){
